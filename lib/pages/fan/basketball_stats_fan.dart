...
class BasketballStatsPageFan extends StatefulWidget {
  final String date;
  final String gameId;
  ...
  BasketballStatsPageFan(
      ...
      this.firstTeamScore});
  @override
  _BasketballStatsPageFanState createState() => _BasketballStatsPageFanState();
}

class _BasketballStatsPageFanState extends State<BasketballStatsPageFan> {
