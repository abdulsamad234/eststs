...
class FanPaymentPage extends StatefulWidget {
  @override
  _FanPaymentPageState createState() => _FanPaymentPageState();
}

class _FanPaymentPageState extends State<FanPaymentPage> {
      ...
      if (purchaseDetails.productID == 'fan_subscription') {
        ...
        if (purchaseDetails.status == PurchaseStatus.pending) {
          ...
          if (purchaseDetails.status == PurchaseStatus.error) {
            ...
            print('Error: ${PurchaseStatus.error}');
          ...
          if (purchaseDetails.pendingCompletePurchase) {
            var res = await InAppPurchaseConnection.instance
                .completePurchase(purchaseDetails);
