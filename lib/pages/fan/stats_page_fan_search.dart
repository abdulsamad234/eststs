...
import 'package:estats/pages/fan/player_stats_fan_search.dart';
...
class StatsPageFanSearch extends StatefulWidget {
  final String date;
  final String gameId;
  ...
  StatsPageFanSearch(
      ...
      this.schoolName});
  @override
  _StatsPageFanSearchState createState() => _StatsPageFanSearchState();
}

class _StatsPageFanSearchState extends State<StatsPageFanSearch> {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => PlayerStatsFanSearchPage(
  ...
  void initState() {
    ...
    super.initState();
    print('Widget team name: ${widget.firstTeamName}');
    getStats();
  }
  ...
  getStats() async {
    ...
    Map<String, dynamic> returnedGameStats = await DataService()
        .getGameStatFanSearch(widget.gameId, widget.schoolName);
