...
class BasketballPlayerStatsFanPage extends StatefulWidget {
  final String playerId;
  BasketballPlayerStatsFanPage({this.playerId});
  @override
  _BasketballPlayerStatsFanPageState createState() =>
      _BasketballPlayerStatsFanPageState();
}

class _BasketballPlayerStatsFanPageState
    extends State<BasketballPlayerStatsFanPage> {
  ...
  getStats() async {
    ...
    Map<String, dynamic> returnedPlayerStats =
        await DataService().getBasketballPlayerStatsFan(widget.playerId);
