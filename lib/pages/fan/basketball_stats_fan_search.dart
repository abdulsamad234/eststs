...
class BasketballStatsPageFanSearch extends StatefulWidget {
  final String date;
  final String gameId;
  ...
  BasketballStatsPageFanSearch(
      ...
      this.schoolName});
  @override
  _BasketballStatsPageFanSearchState createState() =>
      _BasketballStatsPageFanSearchState();
}

class _BasketballStatsPageFanSearchState
    extends State<BasketballStatsPageFanSearch> {
  ...
  getStats() async {
    ...
    Map<String, dynamic> returnedGameStats = await DataService()
        .getBasketballGameStatFanSearch(widget.gameId, widget.schoolName);
