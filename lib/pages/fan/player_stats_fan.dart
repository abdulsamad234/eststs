...
class PlayerStatsFanPage extends StatefulWidget {
  final String playerId;
  PlayerStatsFanPage({this.playerId});
  @override
  _PlayerStatsFanPageState createState() => _PlayerStatsFanPageState();
}

class _PlayerStatsFanPageState extends State<PlayerStatsFanPage> {
                          ...
                          : section == 4
                              ...
                              : row == 0
                                  ? TeamStatCell(
                                      title: 'FG',
                                      subtitle:
                                          '${playerStats['fg']}/${playerStats['fg_attempted']}',
                                    )
                                  : TeamStatCell(
                                      title: 'XP',
                                      subtitle:
                                          '${playerStats['xp']}/${playerStats['xp_attempted']}',
                                    )),
    );
  }
  ...
  getStats() async {
    ...
    Map<String, dynamic> returnedPlayerStats =
        await DataService().getPlayerStatsFan(widget.playerId);
