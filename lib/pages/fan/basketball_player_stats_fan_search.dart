...
class BasketballPlayerStatsSearchPage extends StatefulWidget {
  final String playerId;
  final String schoolName;
  BasketballPlayerStatsSearchPage({this.playerId, this.schoolName});
  @override
  _BasketballPlayerStatsSearchPageState createState() =>
      _BasketballPlayerStatsSearchPageState();
}

class _BasketballPlayerStatsSearchPageState
    extends State<BasketballPlayerStatsSearchPage> {
  ...
  getStats() async {
    ...
    Map<String, dynamic> returnedPlayerStats = await DataService()
        .getBasketballPlayerStatsFanSearch(widget.playerId, widget.schoolName);
