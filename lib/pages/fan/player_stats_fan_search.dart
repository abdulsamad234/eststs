...
class PlayerStatsFanSearchPage extends StatefulWidget {
  final String playerId;
  final String schoolName;
  PlayerStatsFanSearchPage({this.playerId, this.schoolName});
  @override
  _PlayerStatsFanSearchPageState createState() =>
      _PlayerStatsFanSearchPageState();
}

class _PlayerStatsFanSearchPageState extends State<PlayerStatsFanSearchPage> {
  ...
  getStats() async {
    ...
    Map<String, dynamic> returnedPlayerStats = await DataService()
        .getPlayerStatsFanSearch(widget.playerId, widget.schoolName);
