...
class BasketballStatsPage extends StatefulWidget {
  final String date;
  final String gameId;
  ...
  BasketballStatsPage(
      ...
      this.firstTeamScore});
  @override
  _BasketballStatsPageState createState() => _BasketballStatsPageState();
}

class _BasketballStatsPageState extends State<BasketballStatsPage> {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => BasketballPlayerStatsPage(
