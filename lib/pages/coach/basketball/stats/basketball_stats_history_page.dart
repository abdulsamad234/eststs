...
import 'package:estats/pages/coach/basketball/stats/basketball_stats_page.dart';
...
class BasketballStatsHistoryPage extends StatefulWidget {
  @override
  _BasketballStatsHistoryPageState createState() =>
      _BasketballStatsHistoryPageState();
}

class _BasketballStatsHistoryPageState
    extends State<BasketballStatsHistoryPage> {
  ...
  Future getUserInfo() async {
    ...
    List<Map<String, dynamic>> newGames =
        await DataService().getBasketballGames();
    setState(() {
      print('Games returned: $games');
      print('Current user: $newUserData');
                        ...
                        child: Column(
                            ...
                            children: List.generate(games.length, (index) {
                              ...
                              return StatsHistoryCell(
                                ...
                                firstTeamImage: userData['basketballPicUrl'],
