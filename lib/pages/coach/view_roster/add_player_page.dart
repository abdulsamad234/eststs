...
class AddPlayerPage extends StatefulWidget {
  ...
  AddPlayerPage({this.isEditing = false, this.playerData});
  @override
...
class _AddPlayerPageState extends State<AddPlayerPage> {
  ...
  List<String> leftArr = ['Pass', 'Run', 'Kick', 'Return'];
  List<String> rightArr = ['Tackle', 'Sack', 'Intercept', 'Fumble'];
  List<int> leftActiveArr = [0, 0, 0, 0];
  List<int> rightActiveArr = [0, 0, 0, 0];
  ...
  Future<void> addPlayer() async {
    ...
    if (name == '' ||
      ...
      DataService().addPlayer(playerData).then((nothing) {
        setState(() {
          isLoading = false;
        });
        if (nothing) {
  ...
  Future<void> savePlayer() async {
    ...
    if (name == '' ||
      ...
      DataService()
          .savePlayer(playerData, widget.playerData['documentId'])
          .then((nothing) {
        setState(() {
          isLoading = false;
        });
